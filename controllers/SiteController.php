...
class SiteController extends Controller{
    ...
    public function actionIndex(){
        ...
        // META TAGS
        $this->view->title = 'Интернет магазин - всё для танцев в Симферополе';
        ...
        $this->view->registerMetaTag(['name' => 'keywords', 'content' => 'Милонга, одежда для танцев, индивидуальный пошив']);

        // Open Graph Tags
        $this->view->registerMetaTag(['property'=>'og:title', 'content'=> 'Интернет магазин - всё для танцев в Симферополе']);
    ...
    public function actionHowMeasureDress(){
        ...
        $head_keywords = 'как измерить одежду';
    ...
    public function actionSalonAtelier(){
        // META TAGS
        $head_title = 'Заказать костюм для танцев в Симферополе';
        $head_description = 'Самое большое Ателье костюмов в Симферополе по доступным цена.';
        $head_keywords = 'Заказать костюм для танцев, индивидуальный пошив, танцевальный костюм';
        ...
        return $this->render('salon-atelier');
    }
