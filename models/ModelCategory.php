...
class ModelCategory extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['label_en', 'label', 'article', 'head_title', 'head_description', 'head_keywords'], 'required'],
            [['image', 'article', 'url'], 'string'],
            [['label_en', 'label', 'type', 'head_title'], 'string', 'max' => 100],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'label_en' => 'Название категории на английском',
